      ...
      <div className="max-w-[1400px] w-full px-4 md:px-8 relative z-10">
        ...
        <div className="flex flex-col items-center mb-8 text-center w-full">
          ...
          <div className="max-w-4xl mx-auto px-4">
            ...
            <p className="font-main text-gray-600 text-sm md:text-base lg:text-lg leading-relaxed mb-3">
              <Link to="/" className="hover:opacity-80 transition-opacity"><strong><span className="text-brand-red">Red</span><span className="text-brand-gray">Ash</span></strong></Link> was founded in 2007 by <a href="https://www.linkedin.com/in/ashishlalreal/" target="_blank" rel="noopener noreferrer" className="text-brand-blue font-semibold hover:underline">Ashish Lal</a>, an <strong>IIT Delhi engineer</strong>. It has two divisions: <br /> <strong>Enterprise</strong> (<Link to="/ad-agency" className="hover:underline font-bold"><span className="text-brand-red">Red</span><span className="text-brand-gray">Ash</span> <span className="text-brand-blue">Ad Agency</span></Link>) and <strong>Entertainment</strong> (<Link to="/films" className="hover:underline font-bold"><span className="text-brand-red">Red</span><span className="text-brand-gray">Ash</span> <span className="text-brand-red">Films</span></Link>).
            </p>
