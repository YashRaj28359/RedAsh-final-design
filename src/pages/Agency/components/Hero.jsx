...
const Hero = () => {
  return (
    <div className="flex flex-col items-center justify-center text-center z-30 pointer-events-none w-full relative">
      
      <h1 className="font-hero text-5xl md:text-7xl xl:text-[75px] leading-[0.9] tracking-normal text-black uppercase flex flex-col items-center overflow-visible font-bold mb-0">
        <div className="overflow-visible whitespace-nowrap"><span className="block text-black pointer-events-auto">RedAsh <span className="text-brand-blue transition-all duration-300 cursor-default hover:text-transparent hover:[-webkit-text-stroke:2px_#1672EF]">Agency.</span></span></div>
        <div className="overflow-visible whitespace-nowrap text-4xl md:text-5xl xl:text-[55px] opacity-80 mt-1 mb-2"><span className="block text-black">Marketing Campaigns.</span></div>
        ...
        <div className="overflow-visible whitespace-nowrap"><span className="block text-black">Since 2007.</span></div>
      </h1>
