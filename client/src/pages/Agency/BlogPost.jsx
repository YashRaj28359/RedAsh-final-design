      ...
      const applyContent = (data) => {
        if (data?.agency?.blogs && data.agency.blogs.length > 0) {
          ...
          if (data.agency.blogsAllSaved) {
            ...
            setAllBlogs([...dbBlogs, ...remainingStatic]);
          }
        }
      };
    ...
    <div className="min-h-screen bg-white flex flex-col font-main">
      ...
      <section className="pt-24 md:pt-32 pb-12 px-4 md:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto w-full">
          <Link 
            to="/ad-agency/blog" 
            className="inline-flex items-center text-gray-500 md:hover:text-brand-blue active:text-brand-blue mb-8 font-bold text-sm uppercase tracking-widest transition-colors"
          >
